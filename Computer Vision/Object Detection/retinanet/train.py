...
from retinanet.dataloader import CocoDataset, CSVDataset, collater, \
...
def main(args=None):
    parser = argparse.ArgumentParser(description='Training RetinaNet network')
    ...
    if parser.dataset == 'coco':
        ...
        dataset_val = CocoDataset(
            parser.coco_path, set_name='val2017',
    ...
    if dataset_val is not None:
        ...
        dataloader_val = DataLoader(
            dataset_val, num_workers=3, collate_fn=collater,
